...
<html lang = "en">
    <head>
        ...
        <link rel = "stylesheet" type =text/css href ="https://cdnjs.cloudflare.com/ajax/libs/chartist/0.11.0/chartist.min.js.map">
            ...
            <nav class ="navbar navbar-inverse navbar-fixed-top" role ="navigation">
                ...
                <div class ="collapse navbar-collapse navbar-ex1-collapse text-center">
                    <ul class ="nav navbar-nav">
                        ...
                        <li><a onclick="flotr2()"><b>Flotr2</b></a></li>
            ...
            <div id ="page-wrapper">
                ...
                <div class="container-fluid bg-3 text-center kpis">
                    <div class="row">
                        <div class ="col-sm-4">
                            <p>Defects</p>
                            <div id='defects' class ="container-fluid bg-3 text-center dashStyle"></div>
                        </div>
                        <div class ="col-sm-4">
                            <p>Defect Acceptance</p>
                            <div id ="DA" class ="container-fluid bg-3 text-center dashStyle"></div>
                        </div>
                        <div class="col-sm-4">
                            <p>Test Efficiency</p>
                            <div id ="TE" class ="container-fluid bg-3 text-center dashStyle"></div>
                        </div>
                    </div>
                </div>
                <div class ="container-fluid bg-3 text-center">
                    <div class ="row">
                        <p>Bad Fix Defect</p>
                        <div id ="B" class ="container-fluid bg-3 text-center" style="height:200px; width:400px"></div>
                    </div>
                </div>
            </div>
        </div>
